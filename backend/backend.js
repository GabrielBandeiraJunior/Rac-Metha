...
// Função principal para processar todos os dados antes de salvar
...
app.get('/api/dados', async (req, res) => {
  try {
    ...
    console.error('Erro ao listar dados:', error);  // Log de erro detalhado
...
app.post('/racvirtual/register', upload.single('file'), async (req, res) => {
  ...
  try {
    ...
    console.error('Erro ao salvar dados:', error);  // Log de erro detalhado
...
app.get('/racvirtual/:id', async (req, res) => {
  ...
  try {
    ...
    console.error('Erro ao buscar RAC:', error);  // Log de erro detalhado
...
app.put('/racvirtual/edit/:id', async (req, res) => {
  ...
  try {
    ...
    console.error('Erro ao atualizar RAC:', error);  // Log de erro detalhado
